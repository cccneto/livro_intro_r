...
```{r 03-lendo-dados-4, eval=FALSE}
senado <- read_csv("senado.csv")
```

```{r 03-lendo-dados-5, eval=TRUE, echo=FALSE, message=FALSE}
library(readr)
...
```{r 03-lendo-dados-11, eval=FALSE}
...
```{block 03-lendo-dados-12, type='rmdtip'}
<strong>Referências:</strong>  
[Site do pacote `readr` com mais exemplos](https://readr.tidyverse.org)  
[Site do pacote `readxl`, usado para ler arquivos Excel](https://readxl.tidyverse.org)     
```
