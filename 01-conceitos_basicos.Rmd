...
5. Rode o comando abaixo para instalar os pacotes usados neste livro:  

```{r, eval = FALSE}
install.packages(c("broom", "choroplethrMaps", "dplyr", "DT", "dygraphs",
                   "forecast", "gapminder", "ggmap", "ggplot2", "ggrepel",
                   "ggthemes", "gridExtra", "hrbrthemes", "htmltools", "ISLR",
                   "jsonlite", "knitr", "leaflet", "ModelMetrics",
                   "nycflights13", "plotly", "RColorBrewer",  "readr", "readxl",
                   "scales", "stringr", "tidyr", "tidyverse",
                   "titanic", "viridis", "WDI", "xtable", "xts"))
```
