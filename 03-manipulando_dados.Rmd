...
Observe novamente as manipulações feitas acima. Repare que apenas acrescentamos verbetes e encadeamos a manipulação com o uso de `%>%`, chamado de pipe.  
...
```{block, type='rmdtip'}
<strong>Referências:</strong>
[Documentação do pacote magrittr, de onde veio o pipe.`](https://magrittr.tidyverse.org)    
</div>
```
