...
```{r 02-conceitos-basicos-1, echo = FALSE}
library(tidyverse)
```
...
```{r 02-conceitos-basicos-2, echo=FALSE}
2 * 3
```
...
```{r 02-conceitos-basicos-3, eval=FALSE}
7 * 9 + 2 * 6
2.5 * 4
(50 + 7)/(8 * (3 - 5/2))
3 ^ 4
...
```{r 02-conceitos-basicos-11, eval = FALSE}
...
```{r 02-conceitos-basicos-12, eval = FALSE}
